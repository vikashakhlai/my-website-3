...
export class CommentsController {
  ...
  @ApiBadRequestResponse({
    description:
      'Неверные данные запроса. Проверьте обязательные поля и ограничения длины.',
  })
  @ApiUnauthorizedResponse({
    description:
      'Требуется аутентификация. Только авторизованные пользователи могут создавать комментарии.',
  })
  ...
  @Public()
  @ApiOperation({
    summary: 'Получить комментарии по query параметрам',
    description:
  ...
  @Public()
  @ApiOperation({
    summary: 'Получить комментарии по целевой сущности',
    description:
      'Возвращает список комментариев для указанной сущности через параметры пути. ' +
