...
export class TextbooksController {
  ...
  @ApiOperation({
    ...
    description:
      'Возвращает полную информацию об учебнике, включая описание, рейтинги и ссылки на файлы. Публичный эндпоинт, не требует аутентификации. If the request includes a valid JWT token, the response will также include `userRating` и `canDownload`.',
  })
  @ApiParam({
    name: 'id',
